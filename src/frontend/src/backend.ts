...
import type { Dispute as _Dispute, Status as _Status, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDispute(arg0: Dispute): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async deleteDispute(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllDisputes(): Promise<Array<Dispute>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDisputes();
    ...
    async updateDisputeStatus(arg0: bigint, arg1: Status): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDisputeStatus(arg0, to_candid_Status_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Dispute_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Dispute): Dispute {
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "resolved" in value ? Status.resolved : "pending" in value ? Status.pending : "investigating" in value ? Status.investigating : "rejected" in value ? Status.rejected : value;
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Dispute>): Array<Dispute> {
    return value.map((x)=>from_candid_Dispute_n8(_uploadFile, _downloadFile, x));
}
